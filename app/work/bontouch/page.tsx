        ...
        <div className="flex gap-12">
          ...
          <section id="app-reviews" className="scroll-mt-20 mb-16">
            ...
            <div className="flex flex-wrap gap-3 mb-6">
              <span className="px-3 py-1 text-xs font-medium text-gray-400 text-gray-500 bg-gray-800/50 bg-gray-200/70 rounded-full border border-gray-700/50 border-gray-300/70">Benchmarking and talking to other product teams</span>
              ...
              <span className="px-3 py-1 text-xs font-medium text-gray-400 text-gray-500 bg-gray-800/50 bg-gray-200/70 rounded-full border border-gray-700/50 border-gray-300/70">Presentation to Stakeholders</span>
              ...
              <span className="px-3 py-1 text-xs font-medium text-gray-400 text-gray-500 bg-gray-800/50 bg-gray-200/70 rounded-full border border-gray-700/50 border-gray-300/70">User testing</span>
              <span className="px-3 py-1 text-xs font-medium text-gray-400 text-gray-500 bg-gray-800/50 bg-gray-200/70 rounded-full border border-gray-700/50 border-gray-300/70">Keynote</span>
            </div>
            ...
            <div className="mb-8">
              ...
              <div className="bg-gray-800/20 border border-gray-700/50 border-gray-300/70 rounded-xl p-6 mb-6">
                ...
                <p className="text-gray-300 text-gray-600 text-sm">
          ...
          <section id="onboarding" className="scroll-mt-20 mb-16">
            ...
            <div className="flex flex-wrap gap-3 mb-6">
              <span className="px-3 py-1 text-xs font-medium text-gray-400 text-gray-500 bg-gray-800/50 bg-gray-200/70 rounded-full border border-gray-700/50 border-gray-300/70">Understand user needs</span>
              <span className="px-3 py-1 text-xs font-medium text-gray-400 text-gray-500 bg-gray-800/50 bg-gray-200/70 rounded-full border border-gray-700/50 border-gray-300/70">Conduct and perform live user interviews</span>
              <span className="px-3 py-1 text-xs font-medium text-gray-400 text-gray-500 bg-gray-800/50 bg-gray-200/70 rounded-full border border-gray-700/50 border-gray-300/70">Presentation to Stakeholders and Bontouch</span>
              <span className="px-3 py-1 text-xs font-medium text-gray-400 text-gray-500 bg-gray-800/50 bg-gray-200/70 rounded-full border border-gray-700/50 border-gray-300/70">Implementation in app</span>
              <span className="px-3 py-1 text-xs font-medium text-gray-400 text-gray-500 bg-gray-800/50 bg-gray-200/70 rounded-full border border-gray-700/50 border-gray-300/70">Figma</span>
              <span className="px-3 py-1 text-xs font-medium text-gray-400 text-gray-500 bg-gray-800/50 bg-gray-200/70 rounded-full border border-gray-700/50 border-gray-300/70">UI Design</span>
              <span className="px-3 py-1 text-xs font-medium text-gray-400 text-gray-500 bg-gray-800/50 bg-gray-200/70 rounded-full border border-gray-700/50 border-gray-300/70">UX Design</span>
              <span className="px-3 py-1 text-xs font-medium text-gray-400 text-gray-500 bg-gray-800/50 bg-gray-200/70 rounded-full border border-gray-700/50 border-gray-300/70">Project Management</span>
              <span className="px-3 py-1 text-xs font-medium text-gray-400 text-gray-500 bg-gray-800/50 bg-gray-200/70 rounded-full border border-gray-700/50 border-gray-300/70">Cross Collaboration</span>
              <span className="px-3 py-1 text-xs font-medium text-gray-400 text-gray-500 bg-gray-800/50 bg-gray-200/70 rounded-full border border-gray-700/50 border-gray-300/70">Useberry</span>
              <span className="px-3 py-1 text-xs font-medium text-gray-400 text-gray-500 bg-gray-800/50 bg-gray-200/70 rounded-full border border-gray-700/50 border-gray-300/70">Interview Sessions</span>
            </div>
          ...
          <section id="design-system" className="scroll-mt-20 mb-16">
            ...
            <div className="flex flex-wrap gap-3 mb-6">
              <span className="px-3 py-1 text-xs font-medium text-gray-400 text-gray-500 bg-gray-800/50 bg-gray-200/70 rounded-full border border-gray-700/50 border-gray-300/70">Build and effectively make use of components</span>
              <span className="px-3 py-1 text-xs font-medium text-gray-400 text-gray-500 bg-gray-800/50 bg-gray-200/70 rounded-full border border-gray-700/50 border-gray-300/70">Restructure and improve design system</span>
              <span className="px-3 py-1 text-xs font-medium text-gray-400 text-gray-500 bg-gray-800/50 bg-gray-200/70 rounded-full border border-gray-700/50 border-gray-300/70">Streamline design</span>
              <span className="px-3 py-1 text-xs font-medium text-gray-400 text-gray-500 bg-gray-800/50 bg-gray-200/70 rounded-full border border-gray-700/50 border-gray-300/70">Presentation to Stakeholders and Product Team</span>
              <span className="px-3 py-1 text-xs font-medium text-gray-400 text-gray-500 bg-gray-800/50 bg-gray-200/70 rounded-full border border-gray-700/50 border-gray-300/70">Figma</span>
              <span className="px-3 py-1 text-xs font-medium text-gray-400 text-gray-500 bg-gray-800/50 bg-gray-200/70 rounded-full border border-gray-700/50 border-gray-300/70">UI Design</span>
              <span className="px-3 py-1 text-xs font-medium text-gray-400 text-gray-500 bg-gray-800/50 bg-gray-200/70 rounded-full border border-gray-700/50 border-gray-300/70">UX Design</span>
              <span className="px-3 py-1 text-xs font-medium text-gray-400 text-gray-500 bg-gray-800/50 bg-gray-200/70 rounded-full border border-gray-700/50 border-gray-300/70">Project Management</span>
              <span className="px-3 py-1 text-xs font-medium text-gray-400 text-gray-500 bg-gray-800/50 bg-gray-200/70 rounded-full border border-gray-700/50 border-gray-300/70">Design System</span>
              <span className="px-3 py-1 text-xs font-medium text-gray-400 text-gray-500 bg-gray-800/50 bg-gray-200/70 rounded-full border border-gray-700/50 border-gray-300/70">Streamline</span>
              <span className="px-3 py-1 text-xs font-medium text-gray-400 text-gray-500 bg-gray-800/50 bg-gray-200/70 rounded-full border border-gray-700/50 border-gray-300/70">Figma Components</span>
            </div>
