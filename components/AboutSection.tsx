          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <div className="flex flex-col gap-3">
                ...
                {/* Webflow */}
                <div className="flex items-center gap-3 px-4 py-2.5 border border-gray-700/50 rounded-lg">
                  <svg className="w-5 h-5 flex-shrink-0" viewBox="0 0 24 24" fill="#4353FF">
                    <path d="M17.503 0h-4.375L5.91 13.26l3.088 2.986 8.505-10.51v10.51h3.088V0h-3.088zm-11.26 15.71L2.9 18.696 0 15.71l3.343-2.986 2.9 2.986zm2.9-2.986l2.9 2.986 2.9-2.986-2.9-2.985-2.9 2.985zm11.26 0L24 15.71l-2.9 2.986-2.9-2.985 2.9-2.986 2.9 2.986z"/>
                  </svg>
                ...
                <div className="flex items-center gap-3 px-4 py-2.5 border border-gray-700/50 rounded-lg">
                  <svg className="w-5 h-5 flex-shrink-0 text-white" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M18.177 3.823L15.354 1 12.531 3.823 9.708 1 6.885 3.823 4.062 1 1.239 3.823l2.823 2.823L1.239 9.469l2.823 2.823L1.239 15.115l2.823 2.823L1.239 20.761l2.823 2.823 2.823-2.823 2.823 2.823 2.823-2.823 2.823 2.823 2.823-2.823 2.823 2.823 2.823-2.823-2.823-2.823 2.823-2.823-2.823-2.823 2.823-2.823-2.823-2.823z"/>
                  </svg>
